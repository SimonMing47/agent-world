...
spec:
  ...
  imports:
    ...
    environmentTemplates:
      - env-template-merge-request-review
    scheduleTemplates: []
    boardViews:
      - board-code-review-findings
  defaults:
    permissions:
      default: ask
    memory:
...
spec:
  dependencies:
    ...
    skills:
      ...
      - skill-code-review-data-api@1.0.0
  imports:
    taskBlueprints:
      - task-template-shield-mr-review
    environmentTemplates:
...
spec:
  ...
  imports:
    ...
    scheduleTemplates:
      - schedule-daily-security-review
    boardViews:
      - board-security-review-daily
  defaults:
    permissions:
      tools:
        repo.read: allow
